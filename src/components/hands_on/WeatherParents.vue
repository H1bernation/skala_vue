...
const handleUpdateQuery = (newQuery) => {
  console.log('[WeatherParent] 검색어 변경 이벤트를 받았습니다:', newQuery)
  searchQuery.value = newQuery
}
const handleSelectCard = (cityName) => {
  console.log('[WeatherParent] 카드 선택 이벤트를 받았습니다:', cityName)
  selectedCityInfo.value = cityName
}
const handleClickDetail = (humidity) => {
  console.log('[WeatherParent] 상세보기 이벤트를 받았습니다:', humidity)
  showDetail(humidity)
}
const handleUpdateThreshold = (newThreshold) => {
  console.log('[WeatherParent] 기준 온도 변경 이벤트를 받았습니다:', newThreshold)
